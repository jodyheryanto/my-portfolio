  ...
  return (
    <div className="relative z-10">
      <SectionHeader
        ...
        description={
          <div>
            I&apos;m a <span className="text-about_me_green">Modern Infrastructure Interest</span> specialized on <span className="text-about_me_green">Cloud and Automation Infrastructure</span>
          </div>
        }
      />
      <Stars id="about-me" />
      <div className="@container">
        <div className="flex flex-col gap-8 mt-24 @lg:flex-row justify-between">
          <div className="max-w-xl flex-auto">
            ...
            <p className="text-base leading-7 text-about_me_green">Infrastructure Manager</p>
            <p className="mt-4 text-lg text-gray-500">I&apos;m an experienced infrastructure engineer who constantly seeks out innovative solutions to everyday problems.</p>
            <p className="mt-4 text-lg text-gray-500">After 3 years in this industry I have worked with multiple technologies related on modern infrastructure such as ansible and cloud computing.</p>
          </div>
              ...
              >
                ...
                <div className="border-y py-2 border-gray-500/30 mb-6">
                  <div className="flex flex-wrap gap-x-6">
                    ...
                    <div className="text-lg font-bold leading-9 tracking-tight flex gap-1">
                      <p className="text-white">English</p> - <p className="text-gray-500">Conversational</p>
                    </div>
                  </div>
                </div>
              </FadeIn>
              ...
              <GlowCard className="hover:shadow-about_me_green/90" glowClassName="from-[#6bc072] to-[#6bc072]">
                <div className="flex flex-col gap-8 @lg:flex-row justify-between">
                  <div className="flex-none mx-auto self-center">
                    <Image className="rounded-2xl object-fill" src="/umb.jpeg" alt="" width={144} height={144} />
                  </div>
                  <div className="max-w-xl flex-auto">
                    <h3 className="text-lg font-semibold leading-8 tracking-tight text-white">B.S. in Computer Science</h3>
                    <h3 className="text-lg font-semibold leading-8 tracking-tight text-white">Major in Informatics Engineering</h3>
