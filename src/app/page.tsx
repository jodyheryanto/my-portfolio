...
const content: contentSection[] = [
  {
    ...
    sectionHeader: {
      ...
      description: (
        <div>
          <span className="text-work_experience_orange">Infrastructure Manager</span> with <span className="text-work_experience_orange">3 years</span> of experience in the infrastructure industry
        </div>
      ),
    },
  ...
  },
  {
    ...
    sectionHeader: {
      ...
      description: (
        <div>
          <span className="text-skills_purple">Infrastructure</span> engineer with experience in <span className="text-skills_purple">Modern</span> and{' '}
          <span className="text-skills_purple">Cloud</span> infrastructure technologies
        </div>
      ),
    },
    mainContent: <Skills />,
        ...
        <Container>
          <div className="min-h-screen relative">
            <FadeIn className="max-w-5xl pt-40 md:pt-[20vh] 2xl:pt-[30vh]">
              ...
              <p className="max-w-3xl">I am an experienced IT professional with a strong background in infrastructure management, system administration, and technical support. I have extensive experience in overseeing IT operations and leading teams. My expertise includes deploying and managing cloud servers, optimizing system performance, and ensuring security and compliance. My career has included roles from Junior System Administrator to Infrastructure Manager, where I have successfully managed projects and developed effective strategies.</p>
            </FadeIn>
